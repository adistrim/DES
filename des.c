...
int main(int argc, const char * argv[]) {
    ...
    uint64_t input = 0x9474B8E8C73BCA7D; // hexademical value of 64 bit input
    uint64_t key = 0x0000000000000000; // hexademical value of 64 bit key
    uint64_t result = input; // hexademical value of 64 bit result
